 ...
 */
public class AltaAsesor extends javax.swing.JFrame {
        ...
        if(id.isEmpty() || nom.isEmpty() || Tel.isEmpty() || Sueldo.isEmpty()|| AP.isEmpty()|| AM.isEmpty()) {
            ...
            if(verNom == true && verAp == true && verAm == true&& verificadorTel(Tel) == true && verificadorSueldo(Sueldo) == true ) {
                try {
                    ...
                    String insertar = "insert into Asesor (IdAsesor,Nom,AP,AM,Sueldo,Telefono_T)values(?,?,?,?,?,?)";
                    ...
                    ps.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Asesor agregado correctamente");
                    ps.close();
                    con.close();
                    this.dispose();
                    ...
                    JOptionPane.showMessageDialog(null, "Asesor no agregado correctamente" + e.getMessage());
                }
